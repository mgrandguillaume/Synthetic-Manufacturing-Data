                    ...
                    children=html.Div([
                        ...
                        html.Div([
                            ...
                            _range_row("Weibull λ (scale, h)",
                                       ...
                                       hint="Characteristic life of a machine in hours. Higher values mean machines survive longer before failing. MTTF = λ · Γ(1 + 1/β)."),
                            _range_row("MTTR (h)",
                                       "cfg-fail-mttr-lo", "cfg-fail-mttr-hi",
                                       fail.get("mttr",           [0.5, 4.0])[0],
                                       fail.get("mttr",           [0.5, 4.0])[1], step=0.1,
                                       hint="Mean Time To Repair in hours, sampled per failure event. Together with MTTF, determines availability: A = MTTF / (MTTF + MTTR)."),
